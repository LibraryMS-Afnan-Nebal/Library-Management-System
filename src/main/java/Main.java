...
public class Main {
        ...
        private static void changerUsernameOrPassword(AccountManager accountManager)
        {
            ...
            if ("1".equals(ch)) {
                ...
                try {
                    boolean ok = accountManager.changeUsername(currentUser.getUsername(), newU);
                    if (ok) {
                        ...
                        System.out.println("Failed to change username. It may be taken");
                    }
                ...
                boolean ok = accountManager.changePassword(currentUser.getUsername(), newP);
                if (ok) {
            ...
            case "1": // Book search
                ...
                switch (bkOpt) {
                    case "1":
                       ...
                       System.out.println( BookManager.getInstance().displaySearchByTitle(bt, person));
                        break;
                    case "2":
                        System.out.print("Enter Book author: ");
                        String ba = scanner.nextLine();
                      System.out.println(BookManager.getInstance().displaySearchByAuthor(ba, person));
                        break;
                    case "3":
                        System.out.print("Enter full ISBN (13 digits): ");
                        String bi = scanner.nextLine();
                        System.out.println (BookManager.getInstance().displaySearchByISBN(bi, person));
                        break;
                    default:
                        System.out.println("Invalid option.");
                }
            ...
            case "2": // CD search
                ...
                switch (cdOpt) {
                    case "1":
                       ...
                       System.out.println( CDManager.getInstance().displaySearchByTitle(ct, person));
                        break;
                    case "2":
                        System.out.print("Enter CD artist: ");
                        String ca = scanner.nextLine();
                        System.out.println(CDManager.getInstance().displaySearchByAuthor(ca, person));
                        break;
                    default:
                        System.out.println("Invalid option.");
                }
    ...
    public static void main(String[] args) {
        Main main = new Main();
        userManager.signUp("u","1","nebalbadran2424@gmail.com2" +
                "u");
        userManager.signUp("user2","pass2","s12217274@stu.najah.edu");
    ...
    private static void adminMenu() {
        ...
        while (!back && currentUser != null) {
            ...
            switch (choice)
            {
                ...
                case "2": // Unregister User
                   boolean foundd= userManager.printAllUsers();
                   if (foundd) {
                ...
                case "5": // Send Reminder
                    ...
                    String email = dotenv.get("USER_NAME");
                   ...
                   boolean flag = reminderService.sendReminders();
                   if (flag)
                    System.out.println("Reminders sent successfully!");
                    break;

                         case "6": // change Username or password
                           changerUsernameOrPassword(adminManager);
                             break;
        ...
        while (!back && currentUser != null) {
            ...
            switch (choice) {
                    ...
                    switch (borrowType) {
                        case "1": // Borrow Book
                            ...
                            if (availableAuthors.size() == 1) {
                               ...
                               System.out.println(BookManager.getInstance().displaySearchByTitle(bookTitle, currentUser));
                        ...
                        case "2": // Borrow CD
                            ...
                            if (availableArtists.size() == 1) {
                                ...
                                System.out.println(CDManager.getInstance().displaySearchByTitle(cdTitle, currentUser));
                    ...
                    switch (returnType) {
                        case "1", "2": // Book or CD
                            ...
                            if (authors.size() == 1) {
                                ...
                                if (isBook) System.out.println(BookManager.getInstance().displaySearchByTitle(titleInput, currentUser));
                                else System.out.println(CDManager.getInstance().displaySearchByTitle(titleInput, currentUser));
                ...
                case "6": // Change Username or password
                    changerUsernameOrPassword(userManager);
                    break;
        ...
        while (!back && currentUser != null) {
            ...
            switch (choice) {
                ...
                case "2": // Change Username or Password
                    changerUsernameOrPassword(librarianManager);
                    break;
